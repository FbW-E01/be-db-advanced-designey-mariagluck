# Backend - Database Advanced - Design? In my backend?
    ...
    **user actions**
    ...
    ![twitterSchema](schema_image/myTwitterSchema.drawio.png)
    

   <img  src=“schema_image/myTwitterSchema.drawio.png” width=“964”/>
